...
(function ($) {     $(document).ready(function () {          $(function(){             $(".player").YTPlayer();         });          $('#video-play').click(function (event) {             event.preventDefault();             if ($(this).hasClass('fa-play')) {                 $('.player').playYTP();             } else {                 $('.player').pauseYTP();             }             $(this).toggleClass('fa-play fa-pause');             return false;         });          $('#video-volume').click(function (event) {             event.preventDefault();             $('.player').toggleVolume();             $(this).toggleClass('fa-volume-off fa-volume-up');             return false;         });      }); })(jQuery);